...
export const images = [
  {
    src: Rectangle_786,
    alt: "P264: Wash skin thoroughly after handling",
    description: "P271: Use only outdoors or in a well-ventilated area",
  },
  {
    src: Rectangle_788,
    alt: "Rectangle_788",
  ...
  },
  {
    src: Rectangle_770,
    alt: "Rectangle_770",
    description: "P501: Dispose of contents/container",
  },
  {
    src: Rectangle_792,
    alt: "Rectangle_792",
    description: "P302 + P352: IF ON SKIN: Wash with plenty of soap and water",
  },
  {
    src: Rectangle_794,
    alt: "Rectangle_794",
